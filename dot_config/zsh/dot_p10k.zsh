# Generated by Powerlevel10k configuration wizard on 2025-11-22 at 00:46 CET.
...
() {
  ...
  # ANSI sequenzen für bold on off.
  local BOLD=$'%{\e[1m%}'
  local NORM=$'%{\e[0m%}'
  
  # Text
  typeset -g POWERLEVEL9K_VI_COMMAND_MODE_STRING="${BOLD}NORMAL${NORM}"
  typeset -g POWERLEVEL9K_VI_INSERT_MODE_STRING="${BOLD}INSERT${NORM}"
  typeset -g POWERLEVEL9K_VI_VISUAL_MODE_STRING="${BOLD}VISUAL${NORM}"
  typeset -g POWERLEVEL9K_VI_OVERWRITE_MODE_STRING="${BOLD}OVERTYPE${NORM}"

  # Colors (ANSI)
  typeset -g POWERLEVEL9K_VI_MODE_FOREGROUND=16 # Foreground color. - deep black and prolly more theme acnostic than 0.

  typeset -g POWERLEVEL9K_VI_MODE_NORMAL_BACKGROUND=4 # blue
  typeset -g POWERLEVEL9K_VI_MODE_INSERT_BACKGROUND=2 # green
  typeset -g POWERLEVEL9K_VI_MODE_VISUAL_BACKGROUND=140 # lavender
